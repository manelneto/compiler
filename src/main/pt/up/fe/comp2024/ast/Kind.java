...
public enum Kind {
    ...
    private static final Set<Kind> EXPRESSIONS = Set.of(BINARY_EXPR, INTEGER_LITERAL, VAR_REF_EXPR, BOOLEAN_LITERAL, THIS, NEW_OBJECT, FUNCTION_CALL, ARRAY, PAREN_EXPR, NEW_ARRAY);
