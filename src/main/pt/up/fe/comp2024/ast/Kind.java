...
public enum Kind {
    ...
    private static final Set<Kind> STATEMENTS = Set.of(ASSIGN_STMT, ARRAY_ASSIGN_STMT, RETURN_STMT, IF_ELSE_STMT, WHILE_STMT, SIMPLE_STMT, STMT_BLOCK);
    private static final Set<Kind> EXPRESSIONS = Set.of(BINARY_EXPR, INTEGER_LITERAL, VAR_REF_EXPR, BOOLEAN_LITERAL, THIS, NEW_OBJECT, FUNCTION_CALL, ARRAY, PAREN_EXPR, NEW_ARRAY, LENGTH);
